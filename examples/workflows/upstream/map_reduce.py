...
from hera.workflows import Workflow, DAG, script, S3Artifact, NoneArchiveStrategy, Artifact
...
@script(
    inputs=Artifact(name="port", path="/mnt/in/part.json"),
    outputs=S3Artifact(
        name="part",
        key="{{workflow.name}}/results/{{inputs.parameters.partId}}.json",
        path="/mnt/out/part.json",
